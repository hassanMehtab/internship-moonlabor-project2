...
const removeCartItem = (cartItems , cartItemToRemove) =>{
    const existingCartItem = cartItems.find((cartItem) => cartItem.id === cartItemToRemove.product.id
    ...
    return cartItems.map((cartItem ) => cartItem.id === cartItemToRemove.product.id 
    ?
     {...cartItem, quantity : cartItem.quantity - 1}   
     : cartItem.product
...
export  const  CartProvider =  ({children}) => {
    ...
    const value = {cartItems, isCartOpen , setIsCartOpen , addItemToCart , cartCount , removeItemToCart , clearItemFromCart , cartTotal} 
return ( 
